...
import com.bluej.chitchat.databinding.ActivitySignupBinding;
...
private PreferenceManager preferenceManager;
    ...
    private void setListener(){
        ...
        binding.layoutImage.setOnClickListener(view -> {Intent intent=new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    private String encodeImage(Bitmap bitmap){
        ...
        Bitmap preiviewBitmap=Bitmap.createScaledBitmap(bitmap,previewWidth,previewHeight,false);
        ByteArrayOutputStream byteArrayOutputStream=new ByteArrayOutputStream();
        preiviewBitmap.compress(Bitmap.CompressFormat.JPEG,50,byteArrayOutputStream);
        ...
        if(result.getResultCode()==RESULT_OK){
            if(result.getData()!=null){
                ...
                try{
                    ...
                    binding.textaddProfileImage.setVisibility(View.GONE);
